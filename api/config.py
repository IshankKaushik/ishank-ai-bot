...
#After setting up 13 rounds of dialogue, prompt the user to start a new dialogue
prompt_new_threshold = int(13)
...
command_list = "» created by @IshankKaushik ❤️"
...
prompt_new_info = "'type /new to start a new chat'"
